	...
	public static void main(String[] args) {
		...
		while(true) 
		{
			...
			if(choice == 1) 
			{
				...
				System.out.println("전교생 수 = " + namkang.arScore.length + "명");
			...
			else if(choice == 2) 
			{
				...
				System.out.println("학번 : " + namkang.arHakbun[maxIdx]);
			...
			else if(choice == 3) 
			{
				...
				System.out.println("학번 : " + namkang.arHakbun[minIdx]);
			...
			else if(choice == 4) 
			{
				...
				if(check == -1) System.out.println("학번을 잘못 입력하였습니다.");
				else 
				{
					System.out.println(hakbun + 
							"학번 학생의 성적은 " + namkang.arScore[check] + 
							"점 입니다.");
				}
			}
			// 종료하기
